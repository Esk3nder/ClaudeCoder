...
Place trailers at end of body after blank line.
...
When working from a PRD generated by `/plan`:

1. Reference story IDs in commits: `Part of US-001`
2. Reference requirements: `Addresses Req N`
3. Use story title as scope hint
